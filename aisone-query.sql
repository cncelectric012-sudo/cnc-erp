SELECT
    ...
    CASE
        WHEN EXISTS(SELECT 1 FROM TBU_AccountsSegment WHERE VMDID=a.PKGUID AND SegmentDID='20502C3C-F380-43B7-B76B-46FCB2742771')
             AND EXISTS(SELECT 1 FROM TBU_AccountsSegment WHERE VMDID=a.PKGUID AND SegmentDID='6C135D33-5959-4306-A7B3-23E6C83F72A8')
        THEN 'CO,KHI'
        WHEN EXISTS(SELECT 1 FROM TBU_AccountsSegment WHERE VMDID=a.PKGUID AND SegmentDID='6C135D33-5959-4306-A7B3-23E6C83F72A8')
        THEN 'KHI'
        ELSE 'CO'
    END AS Segment
FROM TBU_Accounts a
